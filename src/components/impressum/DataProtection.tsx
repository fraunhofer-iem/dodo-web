...
const DataProtection = () => {
  ...
  return (
    <ContentWrapper
      ...
      background={PossibleColors.WHITE}
    >
      <Typography className={classes.box} variant="h4" color="textSecondary">
        DoDo
      </Typography>
      <Typography className={classes.box} variant="body2" color="textSecondary">
        <p>
      ...
      <Typography className={classes.box} variant="body2" color="textSecondary">
        <p>
          ...
          <p>
            ...
            Protection Officer directly at any time with your questions
            concerning the Data Protection Law or your rights as data subject.
            Alternatively, you may want to send an email to your contact partner
            Dr. Matthias Meyer at matthias.meyer@iem.fraunhofer.de.
          </p>
        </p>
      </Typography>
      <Typography className={classes.box} variant="h4" color="textSecondary">
      ...
      <Typography className={classes.box} variant="body2" color="textSecondary">
        <p>
          ...
          <p>
            We make every reasonable effort to ensure that the content of this
            Web site is kept up to date, and that it is accurate and complete.
            Nevertheless, the possibility of errors cannot be entirely ruled
            out. We do not give any warranty in respect of the timeliness,
            accuracy or completeness of material published on this Web site, and
            disclaim all liability for (material or non-material) loss or damage
            incurred by third parties arising from the use of content obtained
            from the Web site.
          </p>
          <p>
            Registered trademarks and proprietary names, and copyrighted text
            and images, are not generally indicated as such on our Web pages.
            But the absence of such indications in no way implies that these
            names, images or text belong to the public domain in the context of
      ...
      <Typography className={classes.box} variant="body2" color="textSecondary">
        <p>
          ...
          <p>
            <ul>
              <li>
                You consented explicitly pursuant to point (a) of the first
                sentence of Article 6(1) GDPR,
              </li>
              <li>
                The data transfer is necessary pursuant to point (b) of the
                first sentence of Article 6(1) GDPR for the performance of a
                contract with you,
              </li>
              <li>
                We are legally obligated to transmit the data pursuant to point
                (c) of the first sentence of Article 6(1) of GDPR.
              </li>
            </ul>
          </p>
          <p>
      ...
      <Typography className={classes.box} variant="body2" color="textSecondary">
        <p>
          ...
          <ul>
            <li>
              Pursuant to Article 7(3) GDPR, you have the right to withdraw at
              any time any consent you may have given to us before. The
              consequence of this is that we may no longer continue the
              respective activity.
            </li>
            <li>
              ...
              Purposes of data processing, the category of the personal data,
              the categories of recipients to whom your data has been or is
              disclosed, the planned storage periods of data, the existence of a
              right to the correction, deletion, restriction of processing and
              objection, the right to appeal, the right to know the origin of
              your data in the event that we did not collect these data The
              right to meaningful and detailed information on the existence of
              automated decision-making including profiling and, if applicable,
              relevant information on the details thereof;
            </li>
            <li>
              Pursuant to Article 16 GDPR, you have the right to obtain without
              undue delay the rectification of inaccurate personal data and/or
              the completion of incomplete personal data stored with us;
            </li>

            <li>
              Pursuant to Article 17 GDPR, you have the right to the erasure of
              your personal data unless the erasure interferes with the
              execution of the right to free expression of opinions and to
              information, with the compliance with legal obligations, is
              necessary in the public interest or for establishing, exercising
            ...
            <li>
              ...
              you oppose the erasure of these data and we no longer need the
              data while you still need the data to establish, exercise or
              defend legal claims or you have raised an objection against the
              data processing pursuant to Article 21 GDPR;
            </li>
            <li>
            ...
            <li>
              Pursuant to Article 77 GDPR, you have the right to lodge a
              complaint with a supervisory authority. Generally, you may find
              such authority at your place of habitual residence, your workplace
          ...
          <p>
            ...
            <p>
              ...
              your particular situation, to the processing of your personal
              data, pursuant to point (e) of Article 6(1) GDPR (data processing
              for the performance of a task carried out in the public interest)
              and of point (f) of Article 6(1) GDPR (data processing on the
              basis of legitimate interests). This shall also apply to profiling
              as prescribed by Article 4(4) GDPR, which is based on this
              provision.
            </p>
            <p>
              Once you file an objection, we will no longer process your
              personal data unless we can demonstrate compelling legitimate
              grounds for processing which override your interests, rights and
              freedoms, or unless the processing serves the establishment,
              exercise or defense of legal claims.
            </p>
            <p>
              To the extent that your objection addresses the processing of data
              for direct advertising, we will stop the processing immediately.
              In this case, citing a specific situation is not required. This
              shall also apply to profiling in as far as it relates to such
              direct advertising.
            </p>
            <p>
